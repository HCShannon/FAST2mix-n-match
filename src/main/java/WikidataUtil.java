...
public final class WikidataUtil {
  private static final String[] WIKIS = new String[]{
    ...
    "angwikiquote", "angwikisource", "arwikibooks", "arwikinews", "arwikiquote", "arwikisource", "arwikiversity", "astwikibooks",
    "astwikiquote", "aswikibooks", "aswikisource", "aywikibooks", "azwikibooks", "azwikiquote", "azwikisource", "bawikibooks", "bewikibooks",
    "bewikiquote", "bewikisource", "bgwikibooks", "bgwikinews", "bgwikiquote", "bgwikisource", "biwikibooks", "bmwikibooks", "bmwikiquote",
    "bnwikibooks", "bnwikisource", "bowikibooks", "brwikiquote", "brwikisource", "bswikibooks", "bswikinews",
    "bswikiquote", "bswikisource", "cawikibooks", "cawikinews", "cawikiquote", "cawikisource", "chwikibooks", "commonswiki",
    "cowikibooks", "cowikiquote", "crwikiquote", "cswikibooks", "cswikinews", "cswikiquote", "cswikisource", "cswikiversity", "cvwikibooks",
    "cywikibooks", "cywikiquote", "cywikisource", "dawikibooks", "dawikiquote", "dawikisource", "dewikibooks", "dewikinews",
    "dewikiquote", "dewikisource", "dewikiversity", "dewikivoyage", "elwikibooks", "elwikinews", "elwikiquote", "elwikisource", "elwikiversity", "elwikivoyage",
    "enwikibooks", "enwikinews", "enwikiquote", "enwikisource", "enwikiversity", "enwikivoyage", "eowikibooks", "eowikinews", "eowikiquote",
    "eowikisource", "eswikibooks", "eswikinews", "eswikiquote", "eswikisource", "eswikiversity", "eswikivoyage", "etwikibooks", "etwikiquote",
    "etwikisource", "euwikibooks", "euwikiquote", "fawikibooks", "fawikinews", "fawikiquote", "fawikisource", "fawikivoyage",
    "fiwikibooks", "fiwikinews", "fiwikiquote", "fiwikisource", "fiwikiversity", "fowikisource", "frwikibooks", "frwikinews", "frwikiquote",
    "frwikisource", "frwikiversity", "frwikivoyage", "fywikibooks", "gawikibooks", "gawikiquote", "glwikibooks", "glwikiquote", "glwikisource",
    ...
    "itwikinews", "itwikiquote", "itwikisource", "itwikiversity", "itwikivoyage", "jawikibooks", "jawikinews", "jawikiquote", "jawikisource",
    "jawikiversity", "kawikibooks", "kawikiquote", "kkwikibooks", "kkwikiquote", "kmwikibooks", "knwikibooks", "knwikiquote", "knwikisource",
    "kowikibooks", "kowikinews", "kowikiquote", "kowikisource", "kowikiversity", "krwikiquote", "kswikibooks", "kswikiquote", "kuwikibooks",
    ...
    "pswikibooks", "ptwikibooks", "ptwikinews", "ptwikiquote", "ptwikisource", "ptwikiversity", "ptwikivoyage", "quwikibooks", "quwikiquote",
    "rmwikibooks", "rowikibooks", "rowikinews", "rowikiquote", "rowikisource", "rowikivoyage", "ruwikibooks", "ruwikinews",
    "ruwikiquote", "ruwikisource", "ruwikiversity", "ruwikivoyage", "sahwikisource", "sawikibooks", "sawikiquote", "sawikisource", "sdwikinews",
    "sewikibooks", "simplewikibooks", "simplewikiquote", "siwikibooks", "skwikibooks", "skwikiquote", "skwikisource",
    "slwikibooks", "slwikiquote", "slwikisource", "slwikiversity", "specieswiki", "sqwikibooks", "sqwikinews", "sqwikiquote", "srwikibooks",
    "srwikinews", "srwikiquote", "srwikisource", "suwikibooks", "suwikiquote", "svwikibooks", "svwikinews", "svwikiquote",
    "svwikisource", "svwikiversity", "svwikivoyage", "swwikibooks", "tawikibooks", "tawikinews", "tawikiquote", "tawikisource", "tewikibooks",
    ...
    "zeawiki", "zhwiki", "zh_classicalwiki", "zh_min_nanwiki", "zh_yuewiki", "zuwiki", "lrcwiki", "gomwiki", "azbwiki", "adywiki",
  };
